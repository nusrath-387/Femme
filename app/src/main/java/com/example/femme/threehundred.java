...
public class threehundred extends AppCompatActivity {
    Button skin_1,skin_2;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_threehundred);
        ...
        skin_1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                startActivity(new Intent(threehundred.this,coughExist.class));
            }
        });
        skin_2.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                startActivity(new Intent(threehundred.this,noCoughExist.class));
            }
        });
    }
    }
